/*
<MODULE_CONTRACT>
<purpose>Legal share index — re-export the translation-policy surface for legal content consumers.</purpose>
<non-goals>
  <item>Do not implement legal policy logic here — the policy lives in translation-policy.ts.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>

...
<CHANGE_SUMMARY>
  ...
  <item>RFC-0082: Delegate YAML reading to @warpgogol/werkstatt-shared/onboarding so single-doc and two-doc RFC-0076-headed files both parse correctly.</item>
</CHANGE_SUMMARY>
*/

import { parseOnboardingArtifactPayload } from "../onboarding/yaml.ts";
import {

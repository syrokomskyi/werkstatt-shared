...
<CHANGE_SUMMARY>
  <item>Initial: extract Lagebild ingress call from send-message API route into a
        DestinationAdapter so it runs inside the QStash delivery callback with
        retries + DLQ + idempotency.</item>
</CHANGE_SUMMARY>
*/
